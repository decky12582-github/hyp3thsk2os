class SettingsWindow extends TabbedPopupWindow
{
    ...
    constructor(boundingBox, startTab = 0)
    {
        ...
        this.settingsPane.addHitbox(new Hitbox(
            ...
            },
            {
                ...
                onmouseenter: function ()
                {
                    showTooltip(_("Subscribe To Updates"), _("Get notified when a new game update comes out."))
                },
                onmouseexit: function ()
                {
                    hideTooltip();
    ...
    render()
    {
        ...
        if(this.currentTabIndex == 0)
        {
            ...
            renderButton(SETTINGS, sellb, _("Subscribe To Updates"), this.boundingBox.width * .30, this.boundingBox.height * .20, this.boundingBox.width * .30, this.boundingBox.height * .05, "14px Verdana", "#000000");
