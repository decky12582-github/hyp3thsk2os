        ...
        if(this.selectedBlueprint)
        {
            ...
            blueprintIngredientsBox.render = function (parentWindow)
            {
                ...
                if(parentWindow.currentTabIndex == 0)
                {
                    ...
                    drawTextWrap(context, parentWindow.selectedBlueprint.craftedItem.item.getDescription(), relativeCoords.x, relativeCoords.y + ingredientsFontSize + 24, (parentWindow.boundingBox.width - relativeCoords.x) * .9, "left", 0.25);
                    context.globalAlpha = 0.6;
                    context.fillStyle = "#111111";
