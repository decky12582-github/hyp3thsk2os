class OilPumpWindow extends TabbedPopupWindow
{
    ...
    render()
    {
        ...
        {
            this.context.drawImage(getOilRigAsset(), 200 * (numFramesRendered % 4), 0, 200, 200, this.boundingBox.width * .3, this.boundingBox.height * .15, this.boundingBox.width * .4, this.boundingBox.height * .5);
        }
        else
        {
