class BattleWindow extends PopupWindow
{
    ...
    render()
    {
        ...
        {
            this.context.drawImage(monsterStats[monsterID][6], monsterStats[monsterID][9] * 3, 0, monsterStats[monsterID][9], monsterStats[monsterID][9], this.boundingBox.width * .4, this.boundingBox.height * .15, (this.boundingBox.width * .25), this.boundingBox.height * .45);
        }
