...
class WorldLayer extends UiLayer
{
    ...
    constructor(boundingBox)
    {
        ...
        //Reactor
        this.addHitbox(new WorldEntityHitbox(1333, {
        ...
        //Buff Lab
        this.addHitbox(new WorldEntityHitbox(1335, {
            x: (this.boundingBox.width / uiScaleX) * .1,
    ...
    renderTopCity()
    {
        if(currentlyViewedDepth < 4)
        {
            ...
            MAIN.drawImage(animatedDrillCenter, animatedDrillCenter.width / 2 * (framesRendered2 % 2), 0, animatedDrillCenter.width / 2, animatedDrillCenter.height, Math.ceil(mainw * .6025), Math.floor(mainh * .712) * ((4 - currentlyViewedDepth) / 4) - Math.ceil(mainh * .2515), mainw * .1723, mainh * .237);
            ...
            if(currentlyViewedDepth < 2)
            {
                ...
                //Need an isAnyQuestComplete function and refactor this and arrow
                for(var i = 0; i < 20; i++)
                {
                    if(quest[i] == 1)
                    {
                        MAIN.drawImage(bulb, 0, 0, 23, 24, Math.ceil(mainw * .646), Math.ceil(mainh * (.32 - (.179 * currentlyViewedDepth) + ((Math.floor(numFramesRendered / 4) % 5) * .002))), Math.floor(mainw * .0125), Math.floor(mainh * .02));
                        break;
                    }
                }
            }
    ...
    renderCaveBuilding()
    {
        if(currentlyViewedDepth >= CAVE_BUILDING_DEPTH && currentlyViewedDepth < CAVE_BUILDING_DEPTH + 10)
        {
            ...
            MAIN.drawImage(
                caveBuildingStuff,
                (numFramesRendered % 3) * caveBuildingStuff.width / 3,
                0,
            ...
            MAIN.drawImage(
                caveBuildingBelt,
                (numFramesRendered % 3) * caveBuildingBelt.width / 3,
                0,
            ...
            MAIN.drawImage(
                ...
                (Math.floor(numFramesRendered / 3) % 2) * frontOfCaveBuildingDrone.width / 2,
                0,
    ...
    renderUndergroundCity()
    {
        if(currentlyViewedDepth > 299 && currentlyViewedDepth < 309)
        {
            ...
            MAIN.drawImage(undergroundcitylights, 926 * (numFramesRendered % 3), (((currentlyViewedDepth - 304) / 4) * 480), 926, 480 - (((currentlyViewedDepth - 304) / 4) * 480), Math.ceil(mainw * .082), Math.ceil(mainh * .111), Math.floor(mainw * .724), Math.floor(mainh * .712) * ((4 - (currentlyViewedDepth - 304)) / 4));
    ...
    renderEndOfWorld()
    {
        ...
        if(currentlyViewedDepth > 1019 && currentlyViewedDepth < 1029)
        {
            ...
            if(isUfoVisible())
            {
                ...
                MAIN.drawImage(worldUfo, (worldUfo.width / 4) * (framesRendered2 % 3), 0, worldUfo.width / 4, worldUfo.height, Math.ceil(mainw * .35) + Math.floor(oscillate(numFramesRendered, 79) * Math.ceil(mainw * .33)), yCoordinateOfLevelTop + Math.ceil(mainh * .17) + Math.floor(oscillate(numFramesRendered, 31) * Math.ceil(mainw * .05)), Math.floor(mainw * .075), Math.floor(mainh * .14));
            }
        }
    ...
    renderReactor()
    {
        if(currentlyViewedDepth > 1332 && currentlyViewedDepth < 1342)
        {
            var yCoordinateOfLevelTop = mainh * .111 + ((4 - (currentlyViewedDepth - 1332)) * .178 * mainh);
            var xCoordinateOfLevel = Math.ceil(mainw * .082);
            var reactorWidth = 0;
            var reactorHeight = 0;
            ...
            MAIN.drawImage(
                reactor_level,
                0,
                (((currentlyViewedDepth - 1337) / 4) * 480),
                926,
                480 - (((currentlyViewedDepth - 1337) / 4) * 480),
                Math.ceil(mainw * .082),
                Math.ceil(mainh * .111),
                Math.floor(mainw * .724),
                Math.floor(mainh * .712) * ((4 - (currentlyViewedDepth - 1337)) / 4)
            );
    ...
    renderBuffLab()
    {
        ...
        {
            var xCoordinateOfLevel = Math.ceil(mainw * .082);
            var yCoordinateOfLevelTop = mainh * .111 + ((4 - (currentlyViewedDepth - 1335)) * .178 * mainh);
    ...
    renderDrill()
    {
        if(currentlyViewedDepth >= depth - 1 && ((depth > 1000 && depth < 1032) || (depth > 1783 && depth < 1813)) && !isStalledDueToBoss() && !isWaitingForLiftoff())
        {
            ...
            MAIN.drawImage(rocketDrillFlames, 168 * (framesRendered2 % 4), 0, 168, 158, Math.ceil(mainw * .805), yCoordinate - Math.ceil(mainh * .062), Math.ceil(mainw * .131), Math.floor(mainh * .234));
            MAIN.drawImage(drillState.drill().worldAsset, 168 * (numFramesRendered % 4), 0, 168, 158, Math.ceil(mainw * .805), yCoordinate, Math.ceil(mainw * .131), Math.floor(mainh * .234));
            MAIN.drawImage(drillState.engine().worldAsset, 168 * (numFramesRendered % 4), 0, 168, 158, Math.ceil(mainw * .805), yCoordinate, Math.ceil(mainw * .131), Math.floor(mainh * .234));
        }
        else if(currentlyViewedDepth == depth)
        {
            ...
            {
                MAIN.drawImage(drillState.drill().worldAsset, 168 * (numFramesRendered % 4), 0, 168, 158, Math.ceil(mainw * .805), Math.ceil(mainh * .766), Math.ceil(mainw * .131), Math.floor(mainh * .234));
                MAIN.drawImage(drillState.engine().worldAsset, 168 * (numFramesRendered % 4), 0, 168, 158, Math.ceil(mainw * .805), Math.ceil(mainh * .766), Math.ceil(mainw * .131), Math.floor(mainh * .234));
            }
            else
            {
    ...
    renderWorkersForDepth(depthToRender, yCoordinateOfLevelTop)
    {
        ...
        if(chestService.chestExistsAtDepth(depthToRender) && !(depthToRender == 0 && activeLayers.hasOwnProperty("Chest")))
        {
            var chest = chestService.getChestAtDepth(depthToRender);
            ...
            if(chest.isGolden)
            {
                if(depthToRender < 1000)
                {
                    ...
                    if(workerLevel < 5)
                    {
                        MAIN.drawImage(found2, 32 * (numFramesRendered % 4), 0, 32, 96, Math.ceil(mainw * (.085 + ((chest.worker - 1) * .072))), yCoordinateOfLevelTop, Math.ceil(mainw * .025), Math.floor(mainh * .142));
                    }
                    else
                    {
                        MAIN.drawImage(window["found" + workerLevel], 32 * (numFramesRendered % 4), 0, 32, 96, Math.ceil(mainw * (.085 + ((chest.worker - 1) * .072))), yCoordinateOfLevelTop, Math.ceil(mainw * .025), Math.floor(mainh * .142));
                    }
                }
                else
                {
                    MAIN.drawImage(foundm2, 32 * (numFramesRendered % 4), 0, 32, 96, Math.ceil(mainw * (.085 + ((chest.worker - 1) * .072))), yCoordinateOfLevelTop, Math.ceil(mainw * .025), Math.floor(mainh * .142));
                }
            } else
            {
                if(depthToRender < 1000)
                {
                    if(workerLevel < 5)
                    {
                        MAIN.drawImage(foundt, 32 * (numFramesRendered % 4), 0, 32, 96, Math.ceil(mainw * (.085 + ((chest.worker - 1) * .072))), yCoordinateOfLevelTop, Math.ceil(mainw * .025), Math.floor(mainh * .142));
                    }
                    else
                    {
                        MAIN.drawImage(window["foundt" + workerLevel], 32 * (numFramesRendered % 4), 0, 32, 96, Math.ceil(mainw * (.085 + ((chest.worker - 1) * .072))), yCoordinateOfLevelTop, Math.ceil(mainw * .025), Math.floor(mainh * .142));
                    }
                }
                else
                {
                    MAIN.drawImage(foundmt, 32 * (numFramesRendered % 4), 0, 32, 96, Math.ceil(mainw * (.085 + ((chest.worker - 1) * .072))), yCoordinateOfLevelTop, Math.ceil(mainw * .025), Math.floor(mainh * .142));
                }
            }

            workerToSkip = chest.worker;
        }
        ...
        for(var m = 1; m <= workersToDisplay; m++)
        {
            if(m != workerToSkip)
            {
                if(!isCapacityFull())
                {
                    ...
                    if(depthToRender < 1000)
                    {
                        MAIN.drawImage(minerImages[workerLevel], 32 * ((numFramesRendered + (m - 1) + depthToRender) % 4), 0, 32, 48, Math.ceil(mainw * (.085 + ((m - 1) * .072))), yCoordinateOfLevelTop + Math.floor(mainh * .075), Math.ceil(mainw * .025), Math.floor(mainh * .071));
                        MAIN.drawImage(minerHatImages[workerLevel], 32 * ((numFramesRendered + (m - 1) + depthToRender) % 4), 0, 32, 48, Math.ceil(mainw * (.085 + ((m - 1) * .072))), yCoordinateOfLevelTop + Math.floor(mainh * .075), Math.ceil(mainw * .025), Math.floor(mainh * .071));
                    }
                    else if(depthToRender <= 1782)
                    {
                        if(m == 8 && depthToRender == 1089) //render jeb, c'mon jeb what are you doing...
                        {
                            drawImageRot(MAIN, lunarMinerImages[workerLevel], 32 * ((numFramesRendered + (m - 1) + depthToRender) % 4), 0, 32, 48, Math.ceil(mainw * (.085 + ((m - 1) * .072))), yCoordinateOfLevelTop + Math.floor(mainh * .075), Math.ceil(mainw * .025), Math.floor(mainh * .071), 180);
                        }
                        else
                        {
                            MAIN.drawImage(lunarMinerImages[workerLevel], 32 * ((numFramesRendered + (m - 1) + depthToRender) % 4), 0, 32, 48, Math.ceil(mainw * (.085 + ((m - 1) * .072))), yCoordinateOfLevelTop + Math.floor(mainh * .075), Math.ceil(mainw * .025), Math.floor(mainh * .071));
                        }
                    }
                    else if(depthToRender >= getTitan().startDepth)
                    {
                        MAIN.drawImage(titanMinerImages[workerLevel], 32 * ((numFramesRendered + (m - 1) + depthToRender) % 4), 0, 32, 48, Math.ceil(mainw * (.085 + ((m - 1) * .072))), yCoordinateOfLevelTop + Math.floor(mainh * .075), Math.ceil(mainw * .025), Math.floor(mainh * .071));
                    }
                }
                else
    ...
    renderForeground(depthToRender)
    {
        ...
        if(currentlyViewedDepth > getTitan().startDepth - 4 && depthToRender > getTitan().startDepth - 3) 
        {
            ...
            if(depthToRender % 4 == 0 && depthToRender % 8 != 0 && depthToRender % 12 != 0)
            {
                MAIN.drawImage(
                    waves2,
                    waves2.width / 4 * (framesRendered2 % 4),
                    0,
                    waves2.width / 4,
                    waves2.height,
                    Math.ceil(mainw * .3),
                ...
                MAIN.drawImage(
                    bubbles5,
                    bubbles5.width / 4 * (framesRendered2 % 4),
                    0,
                    bubbles5.width / 4,
                    bubbles5.height,
                    Math.ceil(mainw * .7),
            ...
            else if(depthToRender % 5 == 0 && depthToRender % 10 != 0)
            {
                MAIN.drawImage(
                    waves1,
                    waves1.width / 4 * (framesRendered2 % 4),
                    0,
                    waves1.width / 4,
                    waves1.height,
                    Math.ceil(mainw * .1),
                ...
                MAIN.drawImage(
                    bubbles1,
                    bubbles1.width / 4 * (framesRendered2 % 4),
                    0,
                    bubbles1.width / 4,
                    bubbles1.height,
                    Math.ceil(mainw * .4),
            ...
            else if(depthToRender % 6 == 0 && depthToRender % 12 != 0)
            {
                ...
                MAIN.drawImage(
                    bubbles4,
                    bubbles4.width / 4 * (framesRendered2 % 4),
                    0,
                    bubbles4.width / 4,
                    bubbles4.height,
                    Math.ceil(mainw * .3),
            ...
            else if(depthToRender % 7 == 0 && depthToRender % 14 != 0)
            {
                MAIN.drawImage(
                    waves3,
                    waves3.width / 4 * (framesRendered2 % 4),
                    0,
                    waves3.width / 4,
                    waves3.height,
                    Math.ceil(mainw * .4),
                ...
                MAIN.drawImage(
                    bubbles2,
                    bubbles2.width / 4 * (framesRendered2 % 4),
                    0,
                    bubbles2.width / 4,
                    bubbles2.height,
                    Math.ceil(mainw * .2),
            ...
            else if(depthToRender % 8 == 0 && depthToRender % 16 != 0)
            {
                MAIN.drawImage(
                    waves4,
                    waves4.width / 4 * (framesRendered2 % 4),
                    0,
                    waves4.width / 4,
                    waves4.height,
                    Math.ceil(mainw * .6),
