...
class HitboxDebug extends UiLayer
{
    ...
    constructor(boundingBox, labelMode = null)
    {
        super(boundingBox);
        if(labelMode)
        {
...
function showHitboxDebug(labelMode = null)
{
    if(!activeLayers.HitboxDebug)
    {
        activeLayers.HitboxDebug = new HitboxDebug({x: 0, y: 0, width: mainw, height: mainh}, labelMode);
