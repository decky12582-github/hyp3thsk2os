...
function showImportPopup()
{
    if(RSc < 3)
    {
        showSimpleInput(_("Paste your import code below"), _("Import Game And Close"), "", processImportCode.bind(this, isMobile()), "Exit");
    }
    else
    {
...
function savegame()
{
    if(playtime >= 14400 && quest[2] == 0) {quest[2] = 1;}
    if(playtime >= 86400 && quest[8] == 0) {quest[8] = 1;}
    if(chosen > -1)
    {
        savetime = servertime;
        var text = getB64SaveText();
...
function loadGame(x)
{
    ...
    if(x < RSc)
    {
        ...
        platform.playMusic();
        document.getElementById('WRAPPERD').style.background = 'url("../../game/desktop/Shared/Assets/UI/gui2.png")'; document.getElementById('WRAPPERD').style.backgroundSize = '100% 100%';
...
function displayCloudBackups()
{
    if(document.getElementById("cloudBackupsUI") == null)
    {
        ...
        cloudBackupsUIExitButton.style.background = "url('../../game/desktop/Shared/Assets/UI/closei.png') no-repeat center";
