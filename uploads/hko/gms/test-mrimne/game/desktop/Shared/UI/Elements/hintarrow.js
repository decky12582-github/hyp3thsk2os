class HintArrow extends Hitbox
{
    ...
    bouncePeriod = 16;     // Bounce period in frames
    phaseShift;
...
class EasyHintArrow extends HintArrow
{
    ...
    constructor(direction, isVisibleFunction, fractionalPadding = 0)
    {
    ...
    onBecomeChild(parent)
    {
        ...
        if(this.direction == "left")
        {
            ...
            this.boundingBox.x = parent.boundingBox.width + padding;
            this.boundingBox.y = (parent.boundingBox.height - this.boundingBox.height) / 2;
        }
        else if(this.direction == "right")
        {
            padding = this.fractionalPadding * parent.boundingBox.width;
            this.boundingBox.x = -this.boundingBox.width - padding;
            this.boundingBox.y = (parent.boundingBox.height - this.boundingBox.height) / 2;
        }
        else
        {
            padding = this.fractionalPadding * parent.boundingBox.height;
            this.boundingBox.x = (parent.boundingBox.width - this.boundingBox.width) / 2;
            this.boundingBox.y = -this.boundingBox.height - padding;
        }
    }
}