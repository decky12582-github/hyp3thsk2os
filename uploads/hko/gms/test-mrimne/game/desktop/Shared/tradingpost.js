...
{
    var level = tradingPostStructures[worldIndex].level;
    var leveledStatsValue = tradingPostStructures[worldIndex].leveledStatsValue[level - 1];
            ...
            case TRADE_TYPE_ORE:
                if(!paymentType.subtypes)
                {
                    ...
                    while(paymentSubtype === null && paymentSubtypes.length > 0)
                    {
                        ...
                        var randomOreId = worlds[worldIndex].mineralIdsToSell[tradeRoller.rand(indexOfHighestOre - 2, indexOfHighestOre)];
    ...
    switch(tradeType)
    {
        ...
        case TRADE_TYPE_ORE:
            ...
            else
            {
                ...
                return doBigIntDecimalMultiplication(BigInt(timeValue), mineralCounts[tradeSubtype]);
            }
        case TRADE_TYPE_MONEY:
