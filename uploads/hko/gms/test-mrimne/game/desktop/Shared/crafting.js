...
function canCraftBlueprint(category, blueprintId, level = 0, ingredients = null)
{
...
function learnBlueprint(category, blueprintId, notifyPlayer = true)
{
    if(getBlueprintById(category, blueprintId) && !isBlueprintKnown(category, blueprintId))
    {
...
function generateHtmlForIngredients(ingredients, showSufficiencyIconsAndText = true)
{
    ...
    for(var i in rawIngredients)
    {
        ...
        if(showSufficiencyIconsAndText)
        {
            ...
            var sufficiencyImageDesignator = rawIngredients[i].hasQuantity ? "../../game/desktop/Shared/Assets/UI/checkmark2b.png" : "../../game/desktop/Shared/Assets/UI/xmark.png";
...
{
    if(ingredient.item.getName() == _("Money"))
    {
