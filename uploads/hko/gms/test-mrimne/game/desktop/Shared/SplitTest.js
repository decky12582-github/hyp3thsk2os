...
function runSplitTestSetup()
{
    ...
    switch(splitTestValue1)
    {
        ...
        case 12:
            mainMusic = "../../game/desktop/Shared/Audio/music.mp3";
            headerFont = "KanitM";
            break;
    }
}
...
function initializeTests()
{
    ...
    var musicTest = statsig.getExperiment("background_music");
    mainMusic = musicTest.get("value", "Shared/Audio/newmusic.mp3");
    console.log(mainMusic);

    var drillCoalQuantityTest = statsig.getExperiment("coal_ingredient_quantity_test");
    var coalQuantityForTest = drillCoalQuantityTest.get("value", 20000);
    console.log(coalQuantityForTest);
    drillBlueprints[12].ingredients[1].quantity = coalQuantityForTest;

    var caveSpawnMultiplierTest = statsig.getExperiment("cave_spawn_rate_multiplier");
    var caveSpawnMultiplierRateFromTest = caveSpawnMultiplierTest.get("value", 1.1);
    console.log(caveSpawnMultiplierRateFromTest);
    spawnRateMultiplier = caveSpawnMultiplierRateFromTest;

    var capacityMultiplierTest = statsig.getExperiment("early_capacity_multiplier");
    var capacityMultiplierResultFromTest = capacityMultiplierTest.get("value", 1);
    console.log(capacityMultiplierResultFromTest);
    getDrillEquipById(4).capacity *= capacityMultiplierResultFromTest;
    getDrillEquipById(8).capacity *= capacityMultiplierResultFromTest;

    var userExperienceSeedTest = statsig.getExperiment("ux_roller_seed");
    var userExperienceSeedValueFromTest = userExperienceSeedTest.get("value", 5);
    ...
    var chestRewardSeedValueFromTest = chestRewardSeedTest.get("value", 1);
    ...
    var tradeSeedValueFromTest = tradeSeedTest.get("value", 1);
    console.log(tradeSeedValueFromTest);
    tradeRoller.srand(tradeSeedValueFromTest);

    var timeBetweenTradesMultiplierTest = statsig.getExperiment("time_between_trades_multiplier");
    var timeBetweenTradesMultiplierTestResult = timeBetweenTradesMultiplierTest.get("value", 1);
    console.log(timeBetweenTradesMultiplierTestResult);
    timeBetweenTradesTestMultiplier = timeBetweenTradesMultiplierTestResult;

    var shopVariantIdTest = statsig.getExperiment("shop_variants");
    var shopVariantIdResult = shopVariantIdTest.get("Value", 0);
    console.log(shopVariantIdResult);
    shopVariantId = shopVariantIdResult;
    if(shopVariantId == 2 || shopVariantId == 4 || shopVariantId == 5) //tickets are gold, replace references
    {
    ...
    var garageSparklesTest = statsig.getExperiment("garage_sparkles");
    var showGarageSparkles = garageSparklesTest.get("value", false);
    console.log(showGarageSparkles);

    //#########################################################################


    //########################## This will be PC Only #########################

    var headerFontTest = statsig.getExperiment("header_font_pc");
    headerFont = headerFontTest.get("value", "CFont");
    ...
    var pushUpdateText1Test = statsig.getExperiment("push_update_text1");
    pushUpdateText1 = pushUpdateText1Test.get("value", "Your mine needs attention!");
    console.log(pushUpdateText1);
    ...
    var bottomShopButtonTest = statsig.getExperiment("bottom_shop_button_mobile");
    showShopButtonOnBottom = bottomShopButtonTest.get("value", false);
    console.log(showShopButtonOnBottom);
