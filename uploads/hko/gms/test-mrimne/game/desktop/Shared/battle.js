...
function userMaxHealth()
{
    ...
    var questBonus = (totalQuestsComplete() * 3);
...
var monsterStats = [
    ...
    [30, 270, 1200, 1.05, 1.05, "Stoner", monster03, 5000000000n, 4, 200],
    ...
    [200, 600, 1500, 1.05, 1.05, "Necro", monster07, 250000000000n, 8, 200],
    [30, 300, 1000, 1.00, 1.00, _("Imp Underlord"), ImpBoss, 0n, 2, 200], //400
    ...
    [65, 950, 2500, 1.00, 1.00, _("Demon Beast"), DemonBoss, 0n, 2, 200], //700
