    ...
    if(news.length > 0)
    {
        for(var i = 0; i < news.length; i++)
        {
            ...
            else
            {
                ...
                if(news[i][2])
                {
                    TransientEffectsC.drawImage(flair, (numFramesRendered % 3) * 200, 0, 200, 200, transientEffectContainerW * .42, transientEffectContainerH * .105, transientEffectContainerW * .16, transientEffectContainerH * .16);
