...
function runOfflineProgress()
{
    ...
    if(chestCollectorStorageStructure.level > 0)
    {
        ...
        chestService.removeAllChests(Chest.natural);
        chestService.removeAllChests(Chest.quest);
        chestService.removeAllChests(Chest.excavation);
        chestService.removeAllChests(Chest.buff);
        chestService.removeAllChests(Chest.metaldetector);
    }
